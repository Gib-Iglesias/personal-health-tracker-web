...
export default function MyProgressPage() {
  return (
    <div className="card-base p-6">
      <h3 className="text-lg font-semibold text-foreground mb-1">Evolución de Peso</h3>
      <p className="text-text-muted text-[13px] mb-5">Últimas 8 semanas — Objetivo: 85 kg</p>
